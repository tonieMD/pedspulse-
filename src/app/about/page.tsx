...
export default function AboutPage() {
  ...
  // Build the Supabase public URL for your narration file:
  const {
    data: { publicUrl: audioUrl },
  } = supabase
    .storage
    .from('episode-audio')
    .getPublicUrl('Hi rashid.mp3') // ← replace with your actual key
  ...
  // Your three “pillars” of PedsPulse
  const pillars = [
    {
  ...
  return (
    <div className="min-h-screen bg-[#050A12] text-white flex flex-col items-center px-6 py-16 relative overflow-hidden">
      ...
      <p className="relative mt-4 text-gray-400 z-10">
        Hear our mission in your ears
      </p>
